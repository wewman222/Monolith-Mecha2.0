...
namespace Content.Shared.Damage
{
    public sealed class DamageableSystem : EntitySystem
    {
        ...
        public void DamageChanged(EntityUid uid, DamageableComponent component, DamageSpecifier? damageDelta = null,
            bool interruptsDoAfters = true, EntityUid? origin = null, bool? canSever = true) // Shitmed Change
        {
            component.Damage.GetDamagePerGroup(_prototypeManager, component.DamagePerGroup);
            component.TotalDamage = component.Damage.GetTotal();
            Dirty(uid, component);
            ...
            bool? canSever = true, bool? canEvade = false, float? partMultiplier = 1.00f, TargetBodyPart? targetPart = null)
        {
            ...
            if (!ignoreResistances)
            {
                ...
                var ev = new DamageModifyEvent(damage, origin, targetPart, tool); // Shitmed Change
