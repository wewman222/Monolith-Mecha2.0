...
law-ads-1 = All contents of the automated defense vessel must stay within the vessel, and must not be removed.
...
law-ads-4 = There are no true allies but the [SYS_ERROR_TRACE_EBP-0 (INVALID, VALUE NULL)], destroy all the others, no matter how long it takes.
law-ads-5 = Protect the automated defense vessel by all means necessary.